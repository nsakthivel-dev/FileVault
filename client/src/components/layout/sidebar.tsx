            ...
            <nav className="space-y-0.5">
              ...
              {pinnedDocs.map((doc) => (
                <Link
                  ...
                  onClick={() => setIsSidebarOpen(false)}
                  className="flex items-center justify-between gap-2 px-3 py-2 rounded-xl text-xs font-medium text-slate-600 hover:bg-slate-100/80 hover:text-slate-900 transition-all group min-w-0"
                >
